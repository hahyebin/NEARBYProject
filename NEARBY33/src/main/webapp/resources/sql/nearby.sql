...
ALTER TABLE FOLLOW ADD CONSTRAINT FOLLOWING_ID_PROFILE_FK FOREIGN KEY (FOLLOWING_ID) 
 REFERENCES PROFILE(ID) ON DELETE CASCADE;

ALTER TABLE FOLLOW ADD CONSTRAINT FOLLOWED_ID_PROFILE_FK FOREIGN KEY (FOLLOWED_ID) 
 REFERENCES PROFILE(ID) ON DELETE CASCADE;
